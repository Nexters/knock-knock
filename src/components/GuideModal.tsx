...
function GuideModal({ onClose }: GuideProps) {
  return (
    <>
      <div className="fixed w-full h-full top-0 left-0 bg-[#18191F] z-100 opacity-80"></div>
      <div className="flex justify-center">
        <div className="w-[80%] h-[60%] absolute top-1/2 -translate-y-1/2">
          <div className="carousel w-[100%] h-[100%]">
            <div id="slide1" className="carousel-item relative w-full flex flex-col">
              <img className="w-[100%] h-1[100%]" src="assets/images/clock.png" alt="시계" />
              <div className="absolute top-[60%] w-full h-[40%] bg-[#46474C] flex flex-col items-center justify-center rounded-bl-lg rounded-br-lg">
                <p className="relative text-[1.125rem] leading-[1.6875rem]">
                  <span className="bg-[#28D899]">플러스 버튼</span>을 눌러
                  <img
              ...
              <div className="absolute left-1/2 bottom-[1.25rem] -translate-x-1/2">
                <a
                  href="#slide1"
            ...
            <div id="slide2" className="carousel-item relative w-full flex flex-col">
              <img className="w-[100%] h-[100%]" src="assets/images/time_table.png" alt="시간표" />
              <div className="absolute top-[60%] w-full h-[40%] bg-[#46474C] flex flex-col items-center justify-center rounded-bl-lg rounded-br-lg">
            ...
            <div id="slide3" className="carousel-item relative w-full flex flex-col">
              ...
              <img className="w-[100%] h-[100%]" src="assets/images/talk.png" alt="토크" />
              <div className="absolute top-[60%] w-full h-[40%] bg-[#46474C] flex flex-col items-center justify-center rounded-bl-lg rounded-br-lg">
                <p className="text-[1.125rem] leading-[1.6875rem]">
